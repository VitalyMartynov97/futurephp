        ...
        <div id="main">
            <div id="main-insaider">
                ...
                <form method="POST" class="pt-2"  action="php/insert_comment.php">
                    ...
                    <input class="form-control input-lg" style="max-width: 400px;" id="name" name="name" type="text" required>
                    <label for="comment" class="mt-3 mb-2">Ваш комментарий</label>
                    <textarea id="comment" name="comment" class="form-control input-lg" style="max-width: 400px; height: 160px;"></textarea>
                    <div id="submit-line">
                        <div></div>
